...
internal class DiskPageImpl(
    override val id: org.jetbrains.edu.dbi2026.PageId,
    private val pageSize: Int,
    override val headerSize: Int = Int.SIZE_BYTES,
    private val bytes: ByteArray = ByteArray(pageSize)) : org.jetbrains.edu.dbi2026.DiskPage {

    private var sourcePage: DiskPageImpl? = null
    constructor(sourcePage: DiskPageImpl): this(sourcePage.id,
        DEFAULT_DISK_PAGE_SIZE, sourcePage.headerSize, sourcePage.bytes.copyOf()) {
    ...
    override fun putRecord(recordData: ByteArray, recordId: org.jetbrains.edu.dbi2026.RecordId): org.jetbrains.edu.dbi2026.PutRecordResult {
