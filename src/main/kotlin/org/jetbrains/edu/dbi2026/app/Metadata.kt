...
val tableRecordParsers = mapOf<String, TableRecordParser>(
    ...
    "cancelled_flight" to { flightRecord(it) as Record3<Any, Any, Any> },
)
...
val attributeValueParsers = mapOf<String, Function<ByteArray, Comparable<Any>>>(
    ...
    "cancelled_flight.num" to Function { flightRecord(it).value1 as Comparable<Any>},
    "cancelled_flight.planet_id" to Function { flightRecord(it).value2 as Comparable<Any>},
    "cancelled_flight.spacecraft_id" to Function { flightRecord(it).value3 as Comparable<Any>},
...
val attributeTypes = mapOf(
    ...
    "cancelled_flight.num" to flightRecord().f1.first as AttributeType<Comparable<Any>>,
    "cancelled_flight.planet_id" to flightRecord().f2.first as AttributeType<Comparable<Any>>,
    "cancelled_flight.spacecraft_id" to flightRecord().f3.first as AttributeType<Comparable<Any>>,
